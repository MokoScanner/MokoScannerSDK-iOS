...
@implementation MKBLETaskOperation
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    [self dataParserReceivedData:[MKTaskDataAdopter parseReadDataFromCharacteristic:characteristic]];
}
